...
$faqs = [
    ...
    [
        ...
        <p></p>
        Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a class="link" href="#">Centro Google per la sicurezza online</a>.
        <p></p>
        <a class="link" href="#">Scopri </a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.'
    ],
    [
...
<body>
    <header>
        <div class="upper">
            <img class="logo" src="./img/logo-google.png" alt="google">
